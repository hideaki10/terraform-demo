...
output "vpc_enable_dns_support" {
  ...
  value       = aws_vpc.example.enable_dns_support
}
output "vpc_enable_dns_hostnames" {
  description = "Whether or not the VPC has DNS hostname support"
  value       = aws_vpc.example.enable_dns_hostnames
}
output "vpc_enable_classiclink" {
  description = "Whether or not the VPC has Classiclink enabled"
  value       = aws_vpc.example.enable_classiclink
}
output "vpc_main_route_table_id" {
  description = "The ID of the example route table associated with this VPC. Note that you can change a VPC's example route table by using an aws_example_route_table_association."
...
output "vpc_ipv6_association_id" {
  ...
  value       = aws_vpc.example.ipv6_association_id
}
...
output "subnet_ipv6_cidr_block_association_id" {
  description = "The association ID for the IPv6 CIDR block."
  value       = aws_subnet.example.ipv6_cidr_block_association_id
}
output "subnet_owner_id" {
  description = "The ID of the AWS account that owns the subnet."
  value       = aws_subnet.example.owner_id
}